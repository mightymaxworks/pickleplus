  ...
  try {
    ...
    const translations = {
      en: {
        ...
        sampleData: [
          ['HVGN0BW0', '', 'KGLE38K4', '', '11', '7', '2025-01-15', ''],
          ['MJST45X9', 'SWQR78Z2', 'TBPL91M5', 'LCKM33Y8', '11', '9', '2025-01-15', ''],
          ['DLVW67N4', '', 'EDRX29H6', '', '8', '11', '2025-01-16', 'M'],
        ],
        instructions: [
          ['Bulk Match Upload Instructions'],
          [''],
          ['Format Guidelines:'],
          ['• Use player passport codes (e.g., HVGN0BW0, KGLE38K4)'],
          ...
          [''],
          ['Examples:'],
          ['Singles: HVGN0BW0 vs KGLE38K4, scores 11-7'],
          ['Doubles: MJST45X9/SWQR78Z2 vs TBPL91M5/LCKM33Y8, scores 11-9'],
          [''],
          ['Validation will check:'],
          ['• All passport codes exist in the system'],
          ['• Valid score formats'],
      ...
      zh: {
        ...
        sampleData: [
          ['HVGN0BW0', '', 'KGLE38K4', '', '11', '7', '2025-01-15', ''],
          ['MJST45X9', 'SWQR78Z2', 'TBPL91M5', 'LCKM33Y8', '11', '9', '2025-01-15', ''],
          ['DLVW67N4', '', 'EDRX29H6', '', '8', '11', '2025-01-16', '男'],
        ],
        instructions: [
          ['批量比赛上传说明'],
          [''],
          ['格式指南：'],
          ['• 使用选手护照代码（例如：HVGN0BW0, KGLE38K4）'],
          ...
          [''],
          ['示例：'],
          ['单打：HVGN0BW0 对 KGLE38K4，比分 11-7'],
          ['双打：MJST45X9/SWQR78Z2 对 TBPL91M5/LCKM33Y8，比分 11-9'],
          [''],
          ['验证将检查：'],
          ['• 所有护照代码在系统中存在'],
          ['• 有效的分数格式'],
