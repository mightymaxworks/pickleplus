...
const translations: Record<Language, Record<string, string>> = {
  ...
  'zh-CN': {
    ...
    'landing.hero.titleHighlight': '智能分析改变您的泡菜球游戏',
    'landing.hero.description': '加入数千名球员，使用先进的分析、教练工具和社区功能来提升您的泡菜球表现。',
    ...
    'landing.benefits.description': '我们的平台将前沿技术与社区驱动的功能相结合，创造终极泡菜球体验。',
    ...
    'landing.community.description': '与来自世界各地的热情泡菜球球员建立联系，他们正在通过数据驱动的见解改变自己的游戏。',
    ...
    'landing.footer.description': '为泡菜球球员提供跟踪、改进和连接的综合平台。',
