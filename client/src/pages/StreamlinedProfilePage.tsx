        ...
        <div className="mt-4">
          ...
          <TabsContent value="stats" className="mt-0">
            <Card className="p-6">
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold">Stats & Ratings</h3>
                  {isEditMode && (
                    <p className="text-xs text-muted-foreground">Click on any field to edit</p>
                  )}
                </div>
                ...
                {/* Skill Level */}
                <div>
                  <h4 className="text-md font-medium mb-4">Skill Level</h4>
                  {isEditMode && editingFields.skillLevel ? (
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">Self-reported skill level</span>
                      </div>
                      {isEditMode && (
                        <Edit2 className="h-4 w-4 absolute top-2 right-2 text-muted-foreground" />
                      )}
              ...
              {/* Match Stats */}
              <div className="mt-6">
                <h4 className="text-md font-medium mb-4">Match Statistics</h4>
              ...
              {/* Skill Attributes */}
              <div className="mt-8">
                <h4 className="text-md font-medium mb-4">Skill Attributes</h4>
                <div className="space-y-4">
                  {/* Forehand Strength */}
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm">Forehand Strength</span>
                      <span className="text-sm font-medium">{user.forehandStrength || 0}/10</span>
                    </div>
                    {isEditMode && editingFields.forehandStrength ? (
                      <div className="space-y-2">
                        <Slider 
                          value={[forehandStrengthField]} 
                          min={0} 
                          max={10} 
                          step={1}
                          onValueChange={(value) => setForehandStrengthField(value[0])}
                        />
                        <div className="flex justify-end gap-2">
                          <Button 
                            variant="outline" 
                          ...
                          <Button 
                            size="sm"
                            onClick={() => saveProfileField('forehandStrength', forehandStrengthField)}
                          >
                            <Check className="h-4 w-4 mr-1" /> Save
                          </Button>
                        </div>
                      ...
                      <div 
                        className={`${isEditMode ? 'cursor-pointer hover:bg-muted/30 rounded p-2 -mx-2' : ''}`}
                        onClick={() => {
                          if (isEditMode) {
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm">Backhand Strength</span>
                      <span className="text-sm font-medium">{user.backhandStrength || 0}/10</span>
                    </div>
                    {isEditMode && editingFields.backhandStrength ? (
                      <div className="space-y-2">
                        <Slider 
                          value={[backhandStrengthField]} 
                          min={0} 
                          max={10} 
                          step={1}
                          onValueChange={(value) => setBackhandStrengthField(value[0])}
                        />
                        <div className="flex justify-end gap-2">
                          <Button 
                            variant="outline" 
                          ...
                          <Button 
                            size="sm"
                            onClick={() => saveProfileField('backhandStrength', backhandStrengthField)}
                          >
                            <Check className="h-4 w-4 mr-1" /> Save
                          </Button>
                        </div>
