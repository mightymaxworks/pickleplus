...
export default function MobileOptimizedAchievementTracker({
  ...
  return (
    <>
      <Card className="w-full h-96 max-w-full overflow-hidden achievement-mobile-container bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950">
