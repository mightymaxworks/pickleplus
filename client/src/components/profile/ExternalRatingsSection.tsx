...
import { Award, Check, Edit2, ExternalLink, Info } from 'lucide-react';
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="flex items-center gap-1">
                      <h3 className="font-semibold">Dynamic Universal Pickleball Rating (DUPR)</h3>
                      <Info className="h-4 w-4 text-muted-foreground" />
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p className="max-w-xs">
                      DUPR is a global rating system used across all platforms and events with ratings 
                      from 2.0-7.0 that change based on match results.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            <div className="space-y-1 pt-2">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="flex items-center gap-1">
                      <h3 className="font-semibold">USA Pickleball Tournament Player Rating (UTPR)</h3>
                      <Info className="h-4 w-4 text-muted-foreground" />
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p className="max-w-xs">
                      UTPR is the official rating system of USA Pickleball with ratings 
                      from 1.0-6.5 used for tournament eligibility.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            <div className="space-y-1 pt-2">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="flex items-center gap-1">
                      <h3 className="font-semibold">World Pickleball Rating (WPR)</h3>
                      <Info className="h-4 w-4 text-muted-foreground" />
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p className="max-w-xs">
                      WPR provides international ratings based on tournament and league play with a system
                      that updates based on performance against opponents of known ratings.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
