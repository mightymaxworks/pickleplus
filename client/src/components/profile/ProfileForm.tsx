...
export function ProfileForm() {
  ...
  const form = useForm<ProfileUpdateFormData>({
    ...
    defaultValues: {
      ...
      lookingForPartners: user?.lookingForPartners || "",
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Leagues you participate in" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="short">Short (30-45 min)</SelectItem>
                          <SelectItem value="medium">Medium (1-1.5 hours)</SelectItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          placeholder="Any mobility considerations or limitations (optional)" 
                          {...field} 
                        />
                      </FormControl>
                      <FormDescription>
                        This information helps us and potential partners understand your play style
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
