...
export function PCPGlobalRankingCard() {
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>PCP Global Rankings</CardTitle>
          <CardDescription>
            <div className="flex flex-col">
              <span>Track your performance across different formats and age divisions</span>
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            <div className="flex flex-col">
              <span>An error occurred loading your rankings</span>
              <span className="text-xs text-muted-foreground mt-1">Powered by CourtIQ™</span>
            </div>
          </CardDescription>
        </CardHeader>
