...
export function MatchDashboard({
  ...
  return (
    <div className={`${className} space-y-6`}>
      ...
      {/* MATCH-UI-278652[ENHANCE] - Improved mobile layout with better spacing */}
      <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-4 md:gap-5 px-1 py-1">
        {/* Total Matches - Single column on smallest screens */}
        <TiltCard 
          className="border-2 border-primary/20 p-1 overflow-visible bg-gradient-to-br from-background to-muted shadow-md" 
          tiltAmount={8} // Reduced tilt for better mobile usability
          glowOnHover={true}
          glowAlways={true}
          hoverScale={1.03} // Smaller scale for mobile
        >
