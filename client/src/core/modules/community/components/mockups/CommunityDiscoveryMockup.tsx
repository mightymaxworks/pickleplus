    ...
    <div className="space-y-6">
      ...
      <Tabs value={viewType} onValueChange={setViewType} className="w-full">
        ...
        <TabsContent value="map" className="mt-0">
          <div className="bg-muted/50 backdrop-blur-sm rounded-xl h-[560px] overflow-hidden relative border border-muted/80 shadow-inner">
            {/* Map Pattern Background */}
            <div className="absolute inset-0 opacity-20 grid grid-cols-8 grid-rows-6 gap-px">
              {Array.from({ length: 48 }).map((_, i) => (
                <div key={i} className="border border-black/5 flex items-center justify-center">
                  {i % 5 === 0 && (
                    <div className="w-4 h-4 rounded-full border border-black/5"></div>
                  )}
                </div>
              ))}
            </div>
            ...
            {/* Map Mock Pins */}
            <div className="absolute left-[20%] top-[25%] animate-pulse-slow">
              <div className="relative flex flex-col items-center">
                <div className="p-1.5 rounded-full bg-blue-500/70 backdrop-blur-sm shadow-lg">
                  <div className="p-1 rounded-full bg-blue-500 text-white">
                    <Users className="h-5 w-5" />
                  </div>
                </div>
                <div className="w-1 h-6 bg-gradient-to-b from-blue-500 to-transparent -mt-1"></div>
                <div className="bg-white/80 backdrop-blur-sm rounded-lg px-3 py-1.5 shadow-md border border-muted/30 -mt-1 whitespace-nowrap">
                  <p className="text-xs font-medium">Seattle Pickleball Club</p>
                </div>
              </div>
            </div>
            
            <div className="absolute left-[60%] top-[40%] animate-float">
              <div className="relative flex flex-col items-center">
                <div className="p-1.5 rounded-full bg-purple-500/70 backdrop-blur-sm shadow-lg">
                  <div className="p-1 rounded-full bg-purple-500 text-white">
                    <Users className="h-5 w-5" />
                  </div>
                </div>
                <div className="w-1 h-6 bg-gradient-to-b from-purple-500 to-transparent -mt-1"></div>
                <div className="bg-white/80 backdrop-blur-sm rounded-lg px-3 py-1.5 shadow-md border border-muted/30 -mt-1 whitespace-nowrap">
                  <p className="text-xs font-medium">NorCal Tournament Players</p>
                </div>
              </div>
            </div>
            
            <div className="absolute left-[35%] top-[65%] animate-float-delay">
              <div className="relative flex flex-col items-center">
                <div className="p-1.5 rounded-full bg-amber-500/70 backdrop-blur-sm shadow-lg">
                  <div className="p-1 rounded-full bg-amber-500 text-white">
                    <Users className="h-5 w-5" />
                  </div>
                </div>
                <div className="w-1 h-6 bg-gradient-to-b from-amber-500 to-transparent -mt-1"></div>
                <div className="bg-white/80 backdrop-blur-sm rounded-lg px-3 py-1.5 shadow-md border border-muted/30 -mt-1 whitespace-nowrap">
                  <p className="text-xs font-medium">Portland Pickle Smashers</p>
                </div>
              </div>
            </div>
            
            {/* Map Interface Message */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-background/70 backdrop-blur-md rounded-2xl p-6 max-w-lg shadow-xl border border-muted/50 text-center">
                ...
                <p className="text-muted-foreground mb-5">
                  This view would display an interactive map with community locations pinned.
