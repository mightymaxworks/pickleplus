...
export function TournamentManagementPage() {
  ...
  const upcomingTournaments = tournaments?.filter((tournament: any) => {
    const tournamentDate = new Date(tournament.startDate);
    return tournamentDate > new Date();
  }) || [];

  const inProgressTournaments = tournaments?.filter((tournament: any) => {
  ...
  const pastTournaments = tournaments?.filter((tournament: any) => {
    const endDate = new Date(tournament.endDate);
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-xl flex items-center gap-2">
                ...
                <span>Upcoming</span>
                <Badge className="ml-2">{upcomingTournaments?.length || 0}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-xl flex items-center gap-2">
                ...
                <Badge className="ml-2">{inProgressTournaments?.length || 0}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-xl flex items-center gap-2">
                ...
                <span>Completed</span>
                <Badge className="ml-2">{pastTournaments?.length || 0}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">
